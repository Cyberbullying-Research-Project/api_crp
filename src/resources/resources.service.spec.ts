...
describe('ResourcesService', () => {
    ...
    describe('create', () => {
        it('should create a new resource', async () => {
            ...
            jest.spyOn(model, 'create').mockImplementationOnce( () => Promise.resolve([mockResource]));

            const result = await resourceService.create(newResource as CreateResourceDTO, mockUser as User);
    ...
    describe('findById', () => {
        ...
        it('should throw BadRequestException if invalid ID is provided', async () => {
            ...
            await expect(resourceService.getOne(id)).rejects.toThrow(BadRequestException);
        ...
        it('should trhow NotFoundExeption if resource is not found', async () => {
            ...
            await expect(resourceService.getOne(mockResource._id)).rejects.toThrow(NotFoundException);
